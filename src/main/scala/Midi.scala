package nl.roelofruis.akka.serialmidi
...
object Midi extends App {

  // Create the 'helloAkka' actor system
  val system: ActorSystem = ActorSystem("midiserial")

  val settings: SerialSettings = SerialSettings(38400)

  // Create the printer actor
  val terminal: ActorRef = system.actorOf(Terminal("/dev/ttyAMA0", settings))
